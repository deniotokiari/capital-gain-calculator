...
import 'package:stock_service/src/model/symbol_search_response.dart'
    as symbol_search_response_interface;
...
class SymbolSearchMatch implements symbol_search_response_interface.SymbolSearchMatch {
  ...
  factory SymbolSearchMatch.fromJson(Map<String, dynamic> json) =>
      _$SymbolSearchMatchFromJson(json);
