...
@Composable
fun InitProfileCurrency(viewModel: InitProfileCurrencyViewModel = koinViewModel()) {
    ...
    when (val uiState = state) {
        ...
        InitProfileCurrencyViewModel.UiState.Initialized -> LocalNavController.current.navigate("home") {
            popUpTo("init_profile_currency") {
                inclusive = true
            }
        }
