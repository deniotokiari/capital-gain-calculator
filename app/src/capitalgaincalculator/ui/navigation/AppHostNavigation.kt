package legacy.capitalgaincalculator.ui.navigation

import org.koin.core.annotation.Single


@Single(binds = [AppHostNavigation::class])
class AppHostNavigation(override val startDestination: Route, override val destinations: List<Route>) : HostNavigation() {
